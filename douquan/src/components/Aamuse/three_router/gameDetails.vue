<template>
  <div class="detailsContainer">
	<div class="detailsImg">
		<router-link :to="{path:'/amuse/game/gameDelivery',query:{gameType:bookMess.type}}"><img src="../../../../static/img/white_left.png"></router-link>
		<span>游戏</span>
		...
		created(){
			this.$axios.get(getUrl.getGame()).then(res=>{
				   ...
				   for(var i in newBooks[j]){
				   	    if(newBooks[j][i]['name']==this.$route.query.gameMess){
